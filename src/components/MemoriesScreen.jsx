...
export default function MemoriesScreen({ onNext, ...motionProps }) {
    const memories = [
        { id: 1, imgSrc: "./images/b.jpeg", title: "Our First Date", emoji: "💕", color: "from-pink-400 to-purple-500" },
        { id: 2, imgSrc: "./images/c.jpeg", title: "That Cute Selfie", emoji: "📸", color: "from-purple-400 to-pink-500" },
        { id: 3, imgSrc: "./images/d.jpeg", title: "Dancing Together", emoji: "💃", color: "from-blue-400 to-purple-500" },
        { id: 4, imgSrc: "./images/e.jpeg", title: "Sunset Walks", emoji: "🌅", color: "from-orange-400 to-pink-500" },
        { id: 5, imgSrc: "./images/a.jpeg", title: "Dancing Together", emoji: "💃", color: "from-blue-400 to-purple-500" },
